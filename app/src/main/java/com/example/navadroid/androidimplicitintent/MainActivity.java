    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_intent_2:
                ...
                intent.setData(Uri.parse("tel:0838683051" ));
                startActivity(intent);
                break;
            case R.id.btn_intent_3:
                // TODO: Open URL in browser
                intent.setAction(Intent.ACTION_VIEW);
                intent.setData(Uri.parse("https://www.youtube.com/watch?v=OrQZeDHsh_8"));
                startActivity(intent);
                break;
            case R.id.btn_intent_4:
                // TODO: Alam Clock
                intent.setAction(AlarmClock.ACTION_SET_ALARM);
                intent.putExtra(AlarmClock.EXTRA_MESSAGE, "TEST123")
